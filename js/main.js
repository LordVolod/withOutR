...
let reduceLargestElem = arr.reduce(function (a, b) {
  let largestElem = a < b ? b : a;
  return largestElem;
});
console.log(`LargestElem => ${reduceLargestElem}`);

let reduceSmallestElem = arr.reduce(function (a, b) {
  let smallestElem = 0;
  if (a < b) {
    smallestElem = a;
  }
...
console.log(`LargestElem => ${reduceSmallestElem}`);
